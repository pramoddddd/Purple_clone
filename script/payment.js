...
setTimeout(function(){
    ...
    alert("Your payment under process")
...
setTimeout(function(){
    ...
    alert(`Rs ${ans} Debited from your account`)
...
alert("Thank you for purchase from PURPLE")
...
data.forEach(function(e){
    ...
    document.getElementById("adnam").innerText=""
    document.getElementById("addre").innerText="";

    document.getElementById("city").innerText="";
    document.getElementById("pincode").innerText="";
    document.getElementById("mobileNu").innerText="";





    document.getElementById("adnam").append(e.name);
    document.getElementById("addre").append(e.address);

    document.getElementById("city").append(e.City);
    document.getElementById("pincode").append(e.Pincode);
    document.getElementById("mobileNu").append(e.mobile);



})

function GoToAddrPage(){
